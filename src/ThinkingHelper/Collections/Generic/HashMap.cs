...
namespace System.Collections.Generic
{
    ...
    public class HashMap<TKey, TValue> : IReadOnlyDictionary<TKey, TValue>, IDictionary<TKey, TValue>, IDictionary
    {
        ...
        [NotNull] 
        public ReadOnlyDictionary<TKey, TValue>.KeyCollection Keys => ((ReadOnlyDictionary<TKey, TValue>)Dictionary).Keys;

        [NotNull] 
        public ReadOnlyDictionary<TKey, TValue>.ValueCollection Values => ((ReadOnlyDictionary<TKey, TValue>)Dictionary).Values;

        public bool TryGetValue([JetBrains.Annotations.CanBeNull][AllowNull] TKey key, [MaybeNull] out TValue value)
        {
        ...
        public bool ContainsKey([JetBrains.Annotations.CanBeNull][AllowNull] TKey key) => key != null && Dictionary.ContainsKey(key);
